...
func (transaction *Transaction) TransferTX(ctx context.Context, args TransferTXParams) (TransferTXResults, error) {
	var result TransferTXResults

	err := transaction.execTX(context.Background(), func(q *Queries) error {
		var err error
